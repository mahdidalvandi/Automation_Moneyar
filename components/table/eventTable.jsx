        ...
        () => [
            {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        width: "5%",
                        Cell: (props) => (
                            props.row.values.status == 1 && !props.row.values.is_canceled ? <span className="w-3 h-3 inline-block rounded-full text-[11px] font-bold bg-green-500"></span>
                                : props.row.values.status == 0 && props.row.values.is_canceled ? <span className="w-3 h-3 inline-block rounded-full text-[11px] font-bold bg-gray-500"></span> :<span className="w-3 h-3 inline-block rounded-full text-[11px] font-bold bg-red-500"></span>
                        ),
                    },
                    {
                        Header: "نام شرکت",
                    ...
                    },
                    {
                        ...
                        accessor: "status",
                        Cell: (props) => (
                            props.row.values.status == 0 && props.row.values.is_canceled ? "لغو شده" :
                                props.row.values.status == 1 && !props.row.values.is_canceled ? "برگزار شده" : "برگزار نشده"
                        ),
                        disableFilters: false,
                        width: "20%",
                    },
                    ...
                    // },
                    {
                        ...
                        Cell: (props) => (
                            <>
                                {roleData && CheckIfAccess("see_minute") ? props.row.values.hast_minutes ?
                                    <Link
