...
function IncomeHeadingTable(props) {
    function CheckIfAccess(val) {
        if (roleData && roleData.indexOf(val) > -1) return true;
        return false;
    }
        ...
        () => [
            {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        width: "5%",
                        Cell: (props) => (
                            <>{CheckIfAccess("edit_income_headings") && props.row.values.editable ?
                                <Edit
                                    link="/initialData/incomeHeadings/"
    ...
    useEffect(() => {
        async function getData() {
            await axios
                .get("api/v1/company/income_headings/list")
                .then((response) => {
...
export default IncomeHeadingTable;
