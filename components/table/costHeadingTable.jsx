...
function CostHeadingTable(props) {
    function CheckIfAccess(val) {
        if (roleData && roleData.indexOf(val) > -1) return true;
        return false;
    }
        ...
        () => [
            {
                ...
                columns: [
...

                    {
                        ...
                        width: "5%",
                        Cell: (props) => (
                            <>{CheckIfAccess("edit_cost_headings") && props.row.values.editable ?
                                <Edit
                                    link="/initialData/costHeadings/"
    ...
    useEffect(() => {
        async function getData() {
            await axios
                .get("api/v1/company/cost_headings/list")
                .then((response) => {
...
export default CostHeadingTable;
