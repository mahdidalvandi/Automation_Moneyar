        ...
        () => [
            {
                ...
                columns: [
                    ...
                    {
                        Header: "تاریخ شروع نمایش",
                        accessor: "start_timestamp",
                        disableFilters: false,
                        width: "20%",
                        Cell: (props) => (
                            props.row.values.start_timestamp ?
                                <p>{moment.unix(props.row.values.start_timestamp).format("YYYY/MM/DD")}</p>
                                :
                                null
                        )
                    },
                    {
                        Header: "تاریخ پایان نمایش",
                        accessor: "end_timestamp",
                        disableFilters: false,
                        width: "20%",
                        Cell: (props) => (
                            props.row.values.end_timestamp ?
                                <p>{moment.unix(props.row.values.end_timestamp).format("YYYY/MM/DD")}</p>
                                :
                                null
                        )
                    },
                    {
                        ...
                        width: "5%",
                        Cell: (props) => (
                            <>{CheckIfAccess("edit_announcements") ?
                                <Edit
                                    link="/announcements/"
