...
export default function PublicInterviewDialog(props) {
                      ...
                      <tr key={index}>
                          ...
                          {item.title ? (
                            ...
                            <Autocomplete
                              ...
                              onInputChange={(event, newValue) => {
                                changeCompetence(index, newValue);
                              }}
                        ...
                        <td>
                          <input
                            ...
                            placeholder="امتیاز (۱ تا ۱۰)"
                          />
                        </td>
                        <td>
                          <button
                            type="button"
                            onClick={(_) => removeExpected(index)}
