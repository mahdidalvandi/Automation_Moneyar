...
export default function registerIssuedMail(props) {
                ...
                <div className="flex min-h-full items-center justify-center">
                    <Dialog.Panel className="max-w-full rounded bg-white p-5">
                        <Dialog.Title>
                            <div className="max-w-7xl mx-auto px-2 sm:px-2 md:px-4">
                                <div className="bg-white">
                                    <div className="-ml-3 -mt-2 flex items-center justify-center flex-wrap sm:flex-nowrap">
                                        <div className="mt-2">
                                            <h2 className="text-lg leading-6 font-large text-green-900">
                                                نامه صادره با موفقیت ثبت شد
                                            </h2>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div>
                            ...
                            <PrintableReceipt mailDate={props.mailDate ? moment.unix(props.mailDate).format("YYYY/MM/DD") : null} indicator={props.indicator} mailNo={props.mailNo} mailSubject={props.mailSubject} ref={(el) => (componentRef = el)} />
                        </div>
                        <div className="mt-5">
                            {/* <ReactToPrint
                                pageStyle="@page { size: 148mm 210mm; marginLeft:100px}"
                                trigger={() => <button className="bg-[#1f2937] text-white px-2 py-2 rounded-md text-sm inline-block ml-1">چاپ رسید</button>}
            ...
            <div style={{ direction: "rtl" }}>
                <table width="500px">
                    ...
                    <tbody>
                        <tr >
                            <td></td>
                            <td><h2 style={{ alignContent: "center" }}>صدور نامه</h2> </td>
                            <td></td>
                        ...
                        <tr>
                            ...
                            <td> </td>
                            <td>{moment(this.props.mailDate).format('jYYYY/jMM/jDD')}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
