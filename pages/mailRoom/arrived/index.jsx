...
import MailRoomArrivedTable from "../../../components/table/mailRoomArrived";
        ...
        if (data) {
            ...
            if (val.length > 2) {
                ...
                for (let i = 0; i < data.length; i++) {
                    if (data[i].indicator.includes(val) || data[i].letter_number.includes(val) || data[i].letter_sender_name.includes(val) || data[i].letter_subject.includes(val)) {
                ...
                {!currentUserActions ? null : CheckIfAccessToPage(window.location.pathname) ?
                    <main>
                            ...
                            <div className="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
                                <div className="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-nowrap">
                                    ...
                                    <div className="ml-4 mt-2 flex-shrink-0">
                                        ...
                                        {CheckIfAccess("arrived_newMail") ?
                                            <Link href="/mailRoom/arrived/newMail">
                                                <button
                                                    type="button"
                        ...
                        <div className="w-full px-4 sm:px-6 md:px-8">
                            ...
                            <MailRoomArrivedTable data={searchHasValue ? searchData : data} loadingData={loadingData} />
