    ...
    if (data) {
      ...
      if (val.length > 2) {
        ...
        for (let i = 0; i < data.length; i++) {
          if (
            data[i].indicator.includes(val) ||
            data[i].letter_number.includes(val) ||
            data[i].letter_sender_name.includes(val) ||
            data[i].letter_subject.includes(val)
          ) {
          ...
          <main>
            ...
            <div className="w-full px-4 sm:px-6 md:px-8">
              <div className="grid grid-cols-4 gap-y-2 gap-x-4 mb-2 ">
                <form
                  className="w-1/4 flex md:ml-0 mb-2 mt-4 col-span-4"
                  action="#"
                  method="GET"
                >
