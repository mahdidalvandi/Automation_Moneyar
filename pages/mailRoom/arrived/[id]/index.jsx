...
export default function ViewEmail() {
    ...
    const { getMailRoom, mailRoomData, letterContetn, isMailRoomLoading } = useMailRoom();
                                        ...
                                        <div className="mt-2 mb-2 grid grid-cols-1 gap-y-5 gap-x-2 sm:grid-cols-6">
                                                ...
                                                <TextWithLabel
                                                    ...
                                                    text={
                                                        mailRoomData.add_timestamp ?
                                                            moment.unix(mailRoomData.add_timestamp).format("YYYY/MM/DD HH:mm:ss") : null
                                                    }
                                                />
                                            </div>
                                            <div className="sm:col-span-2">
                                                <TextWithLabel
                                                    ...
                                                    text={
                                                        mailRoomData.letter_timestamp ?
                                                            moment.unix(mailRoomData.letter_timestamp).format("YYYY/MM/DD") : null
                                                    }
                                                />
                                            </div>
                                            <div className="sm:col-span-2">
                                                <TextWithLabel
                                                    title="فرستنده نامه"
                                                    text={
                                                        mailRoomData.letter_sender_name
                                                    }
                                                />
                                            </div>
                                            <div className="sm:col-span-2">
                                            ...
                                            <div className="sm:col-span-2">
                                                <TextWithLabel
                                                    title="نحوه ارسال"
                                                    text={
                                                        mailRoomData.letter_received_type ? mailRoomData.letter_received_type : "-"
                                                    }
                                                />
                                            </div>
                                            <div className="sm:col-span-6">
                                            ...
                                            {mailRoomData && mailRoomData.letter_content && mailRoomData.letter_content.length == 2 ?
                                                <>
                                                        ...
                                                        <div className="mb-4">
                                                            ...
                                                            >
                                                                {letterContetn.regarding ?
                                                                    ...
                                                                    >
                                                                        {letterContetn.regarding ? letterContetn.regarding.title : ""}
                                                                    </button> : "ندارد"}
