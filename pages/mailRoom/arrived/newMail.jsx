                      ...
                      <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                ...
                                >
                                  ...
                                  >
                                    <input
                                      ...
                                      type="radio"
                                      disabled="true"
                                      defaultChecked={typeMethods.id === "0"}
                        ...
                        <div className="sm:col-span-4">
                          ...
                          <InputBox
                            ...
                            name={mailNo}
                            value={mailNo}
                            onChange={(event) => setMailNo(event.target.value)}
                        ...
                        <div className="sm:col-span-3">
                          ...
                          <InputBox
                            ...
                            value={receivedType}
                            onChange={(event) =>
                              setReceivedType(event.target.value)
                            }
                            type="text"
                            isrequired="true"
                          />
