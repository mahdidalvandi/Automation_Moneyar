...
function InitialData() {
  ...
  const GetData = () => {
    ...
    axios.get(`api/v1/ticket/list?page=${updatedPINdex}`).then((res) => {
      console.log(res.data.data.data.support_user);
      setLoadingData(false);
      setAllData(res.data.data);
      res.data.data.data.support_user
        ? setTicketSupportData(res.data.data.data.data)
