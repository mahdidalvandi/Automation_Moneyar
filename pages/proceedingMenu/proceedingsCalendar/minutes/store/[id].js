                        ...
                        <div className="space-y-8 divide-y divide-gray-200">
                            <div>
                                ...
                                <div className="pt-5 border-t">
                                    <div>
                                        <p className="text-red-500 text-sm font-bold">{errors['title']}</p>
                                        <p className="text-red-500 text-sm font-bold">{errors['timestamp']}</p>
                                        {
                                            errors.map((err, err_key) => {
                                                return (
                                                    <p key={err_key} className="text-red-500 text-sm font-bold">{err}</p>
                                                )
                                            })
                                        }
