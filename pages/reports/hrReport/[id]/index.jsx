...
export const contractTypeChartOption = {
    responsive: true,
    plugins: {
        legend: {
            position: 'bottom',
...
export const contractChartData = {
    labels: [],
    type: 'pointLabel',
    datasets: [
        {
    ...
    function getNewReport(year = null, selectedMonthParam = null) {
        ...
        axios
            ...
            .then((res) => {
                ...
                var contractBufData = _.cloneDeep(contractChartData);
                ...
                contractBufData.labels = ['دائم', 'موقت', 'معین', 'ثبت نشده'];
                contractBufData.datasets[0].data = res.data.data.contract_data;
                setContractTypeData(contractBufData);
                ...
                <main
                    ...
                    <div className="grid grid-cols-10 gap-10 mt-10">
                        ...
                        <div className="col-span-2 m-4" style={{
                            ...
                            {contractTypeData ?
                                <Pie data={contractTypeData} options={contractTypeChartOption} /> : null}
                        </div>
                        <div className="col-span-1"></div>
