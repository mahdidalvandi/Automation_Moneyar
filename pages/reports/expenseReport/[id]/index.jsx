...
export default function OrganizationalChart() {
  ...
  const [monthRange, setMonthRange] = useState([
    currentMonth == 1 ? currentMonth : currentMonth - 1,
  ...
  function getNewReport(year = null, month = null) {
    ...
    axios
      ...
      .then((res) => {
        ...
        incomeBarData.datasets[0].data =
          res.data.data.sum_income_forecast_values;
        incomeBarData.datasets[1].data =
          res.data.data.sum_income_realized_values;
  ...
  return (
    <div>
      ...
      <div className="md:pr-52 flex flex-col flex-1">
        <StickyHeader />
        <main style={{ direction: "rtl" }} ref={(el) => (componentRef = el)}>
            ...
            <div className=" space-x-3 space-x-reverse ">
              <select
                onChange={(year) => {
                  ...
                  getNewReport(year.currentTarget.value, monthRange);
                }}
              ...
              >
                ...
                {months.map((opt, n) => (
                  <option
                    selected={selectedYear == opt.year}
                    key={n}
                    value={opt.year}
                  >
                    {opt.year}
          ...
          <div className="grid g-4 grid-cols-10 gap-5">
            ...
            <div className="col-span-6">
              {costBarData ? (
                <Chart type="bar" data={costBarData} options={barOptions} />
              ) : null}
            </div>
            <div className="col-span-2">
              <div className="border border-gray-300 shadow-sm text-center rounded-md ml-5 mr-5">
                ...
                <h2
                  className="text-lg leading-6 font-large text-gray-900 mb-1"
                  style={{ fontSize: "30px" }}
                >
            ...
            {incomeData ? (
              <div className="col-span-10 pt-2 pb-2 border-t"></div>
            ) : null}
            <div
              className="col-span-2"
              style={{
            ...
            >
              {incomeData ? (
                <Pie data={incomeData} options={incomeOptions} />
              ) : null}
            </div>

            <div className="col-span-6">
              {incomeBarData ? (
                <Chart type="bar" data={incomeBarData} options={barOptions} />
              ) : null}
            </div>
            <div className="col-span-2">
              <div className="border border-gray-300 shadow-sm text-center rounded-md ml-5 mr-5">
              ...
              <div className="border border-gray-300 shadow-sm text-center rounded-md  ml-5 mt-5 mr-5">
                ...
                <h2
                  className=" leading-6  text-gray-900 mb-1"
                  style={{ fontSize: "30px" }}
                >
