...
import CompanyBanksReportTable from "../../../components/table/companyBanksReportTable";
          ...
          <main>
            <div className="py-6">
                ...
                <div className="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
                  <div className="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-nowrap">
                    <div className="ml-4 mt-2">
                      <h2 className="text-lg leading-6 font-large text-gray-900">گزارش موجودی بانک</h2>
                    </div>                    
                  </div>
                </div>
                {isHolding ?
              ...
              <div className="w-full px-4 sm:px-6 md:px-8">
                {currentUserRole ?
                  <CompanyBanksReportTable loadingData={false} data={searchHasValue ? searchData : data} roleData={currentUserRole} /> : null}
              </div>
            </div>
          </main> : <Forbidden />}
      </div>
