...
import RoundedAdd from "../../../public/images/roundedAdd.png";
import InputBox from "../../../components/forms/inputBox";
import { useState, forwardRef, useEffect } from "react";
import axios from "../../../lib/axios";
import { loadImageFromServer } from "../../../lib/helper";
import AddFile from "../../../public/images/addFile.png";
            ...
            <form autoComplete="off" className="space-y-1 ">
              ...
              <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                <div className="sm:col-span-2">
                  <InputBox
                    ...
                    name={nameAndFamily}
                    value={nameAndFamily}
                    onChange={(event) => setNameAndFamily(event.target.value)}
                        ...
                        >
                          ...
                          >
                            <input
                              ...
                              type="radio"
                              className=" h-4 w-4  border-gray-300 ml-2"
                              onChange={(e) => {
                ...
                <div className="sm:col-span-2">
                  <InputBox
                    ...
                    type="number"
                    onChange={(event) =>
                      setNationalCode(event.target.value.slice(0, 10))
                    }
                ...
                <div className="sm:col-span-2">
                  <InputBox
                    ...
                    onChange={(event) => setReligionBranch(event.target.value)}
                ...
                <div className="sm:col-span-6">
                  <div className="flex justify-start gap-x-10">
                    ...
                    <div className="xs:col-span-1">
                      ...
                      <fieldset className="mt-4">
                        <div className="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-1">
                          {militaryTypeMethods.map((militaryTypeMethods) => (
                            <div
                ...
                <div className="sm:col-span-2">
                  <InputBox
                    ...
                    onChange={(event) =>
                      setDoctorStatusPlace(event.target.value)
                    }
                ...
                <div className="sm:col-span-2">
                  <InputBox
                    ...
                    type="number"
                    onChange={(event) =>
                      setTelephone(event.target.value.slice(0, 11))
                    }
                ...
                <div className="sm:col-span-2">
                  <InputBox
                    ...
                    type="number"
                    onChange={(event) =>
                      setCellPhone(event.target.value.slice(0, 11))
                    }
              ...
              <div className="sm:col-span-6  border-t border-gray-300 py-5">
                <div className="flex justify-between">
                  <p className="text-[#256FCC]">سوابق کاری</p>
                  <div className="flex">
                    <div className="float-left ">
                      <button
                        type="button"
                        onClick={(_) => addResume()}
                        className="hover:bg-gray-50 font-semibold transition text-[#22AA5B] duration-150 p-2 px-4 text-sm flex items-center"
                      >
                        سابقه جدید
                        <Image className="mr-2" src={RoundedAdd} />
                      </button>
                    </div>
                  </div>
                </div>
                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <input
                              ...
                              value={item.manager}
                              onChange={(e) =>
                                changeManager(index, e.target.value)
                              }
                              className="text-sm text-center w-full border-0 p-2"
                          ...
                          <td>
                            <input
                              ...
                              value={item.contact}
                              onChange={(e) =>
                                changeContact(index, e.target.value)
                              }
                              className="text-sm text-center w-full border-0 p-2"
              ...
              <div className="sm:col-span-6 border-t border-gray-300 py-5">
                <div className="flex justify-between">
                  <p className="text-[#256FCC]">سوابق تحصیلی(دو مدرک آخر)</p>
                </div>
                <button
                  type="button"
                  onClick={(_) => addEducation()}
                  className="hover:bg-gray-50 float-left font-semibold text-[#22AA5B] mb-2 mt-2 transition duration-150 p-2 px-4 rounded-md text-sm flex items-center"
                >
                  مقطع جدید
                  <Image className="mr-2" src={RoundedAdd} />
                </button>
                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <input
                              type="text"
                              value={item.gpa}
                              onChange={(e) => changeGpa(index, e.target.value)}
                              className="text-sm text-center w-full border-0 p-2"
                              placeholder="معدل"
                            />
                          </td>
              ...
              <div className="sm:col-span-6 border-t border-gray-300 py-5">
                <div className="flex justify-between ">
                  <p className="text-[#256FCC]">آشنایی با زبان های خارجی</p>
                </div>
                <button
                  type="button"
                  onClick={(_) => addLanguage()}
                  className="hover:bg-gray-50  float-left font-semibold text-[#22AA5B] mt-2 mb-2 transition duration-150  p-2 px-4 rounded-md text-sm flex items-center"
                >
                  زبان جدید
                  <Image className="mr-2" src={RoundedAdd} />
                </button>
              ...
              <div className="sm:col-span-6 border-t border-gray-300 py-5">
                <div className="flex justify-between ">
                  <p className="text-[#256FCC]">مهارت ها</p>
                </div>
                <button
                  type="button"
                  onClick={(_) => addSkill()}
                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <input
                              ...
                              onChange={(e) =>
                                changeSkillExperience(index, e.target.value)
                              }
                              className="text-sm w-full text-center border-0 p-2"
                              placeholder="تجربه"
                            />
              ...
              <div className="sm:col-span-6 border-t border-gray-300 py-5">
                <div className="flex justify-between ">
                  <p className="text-[#256FCC]">سوابق آموزشی</p>
                </div>
                <button
                  type="button"
                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <input
                              ...
                              value={item.duration}
                              onChange={(e) =>
                                changeTrainingDuration(index, e.target.value)
                              }
                              className="text-sm w-full text-center border-0 p-2"
                          ...
                          <td>
                            <input
                              ...
                              onChange={(e) =>
                                changeTrainingOrganizer(index, e.target.value)
                              }
                              className="text-sm w-full text-center border-0 p-2"
                          ...
                          <td>
                            <input
                              ...
                              onChange={(e) =>
                                changeTrainingDescription(index, e.target.value)
                              }
                              className="text-sm w-full text-center border-0 p-2"
                              placeholder="توضیحات"
                            />
                  ...
                  <div className="col-span-2 flex justify-contect pt-3 ">
                    ...
                    <fieldset className="mr-4">
                      <div className="space-y-4 sm:flex  sm:space-y-0 sm:space-x-1">
                        {yesAndNoTypeMethods.map((yesAndNoTypeMethods) => (
                          <div
                ...
                <div className="grid lg:grid-cols-6 w-full gap-y-1 gap-x-4 xs:grid-cols-1">
                  ...
                  <div className="col-span-4 pt-1">
                    <input
                      ...
                      onChange={(e) => setFreeTimeDescription(e.target.value)}
              ...
              <div className="col-span-6 ">
                ...
                <div className="grid lg:grid-cols-6 w-full gap-y-1 gap-x-4 xs:grid-cols-2">
                  <div className="lg:col-span-2 xs:col-span-6 flex justify-contect pt-3 ">
                    ...
                    <fieldset className="mr-4">
                      <div className="space-y-4 sm:flex  sm:space-y-0 sm:space-x-1">
                        {coOperateTypeMethods.map((coOperateTypeMethods) => (
                          <div
                  ...
                  <div className="col-span-4 pt-1">
                    <input
                      ...
                      value={salary}
                      onChange={(e) =>
                        setSalary(addCommas(removeNonNumeric(e.target.value)))
                      }
                      className="text-sm col-span-2 text-right w-full border border-gray-300 rounded-md shadow-sm p-2"
                      placeholder="میزان حقوق درخواستی را بنویسید"
                    />
                  </div>
                </div>
              </div>
                ...
                <div className="sm:col-span-2">
                  {loadingUpload ? (
                    ...
                    <>
                      <label
                        htmlFor="cover-photo"
                        className="block text-sm font-semibold text-[#256FCC]"
                      >
                        فایل رزومه
                      </label>
                      <div className="mt-1 w-28 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                        <div className="space-y-1 [text-align:-webkit-center] items-center ">
                          <Image src={AddFile} className="" />
                          <div className=" text-sm text-gray-600">
                            <label
                              htmlFor="file-upload"
                              className="relative cursor-pointer bg-white rounded-md font-medium focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-amber-500"
                            >
                              <span>اضافه کنید</span>
                              <input
                                id="file-upload"
                                name="file-upload"
                                type="file"
                      ...
                      <p className="text-xs text-gray-500">
                        فایل‌ها کمتر از ۱۰ مگابایت باشند
                      </p>
                    </>
                  ) : attachement != "" ? (
                    <span
                    ...
                    >
                      <button
                        type="button"
                        disabled
                        className="relative inline-flex text-[#256FCC] items-center px-2 rounded-r-md border border-gray-300 bg-white text-sm
                         font-medium  hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500"
                      >
                        {"فایل رزومه"}
                      </button>
                      <button
              ...
              {errors["upload"] ? (
                <span className="text-sm text-red-500">{errors["upload"]}</span>
              ) : null}
              <div className="sm:col-span-6 pt-1 border-t"></div>
              ...
              {errors["master"] ? (
                <span className="text-sm text-red-500">{errors["master"]}</span>
              ) : null}
            </form>
          </div>
        ) : (
