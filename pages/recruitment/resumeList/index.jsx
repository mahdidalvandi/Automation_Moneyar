                    ...
                    <main>
                        <div className="py-6">
                            ...
                            <div className="w-full px-4 sm:px-6 md:px-8">
                                ...
                                <ResumeTable data={searchHasValue ? searchData : searchHashtagsHasValue ? searchHashtagsData : data} loadingData={false} roleData={currentUserRole} isArchived={false} searchedTag={selectedHashtagsTitles}
                                    setClicked={(per) => {
                                        GetData(per)
                                    }}
                                />
