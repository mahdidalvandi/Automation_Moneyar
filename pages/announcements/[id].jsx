...
export default function EditPost() {
    ...
    const { getAnnouncements, announcementsData, isPostLoading } = useAnnouncements();
    ...
    const onSubmit = async (event) => {
        ...
        mailFormData.append("start_timestamp", startTimestamp ? String(startTimestamp.unix) : announcementsData.start_timestamp);
        mailFormData.append("end_timestamp", endTimestamp ? String(endTimestamp.unix) : announcementsData.end_timestamp);
                                                ...
                                                <div className="grid grid-cols-4 gap-2 col-span-3">
                                                    <div className="sm:col-span-2">
                                                        ...
                                                        <DatePicker
                                                            ...
                                                            format="YYYY/MM/DD"
                                                            value={announcementsData.start_timestamp ?
                                                                moment
                                                                    .unix(
                                                    ...
                                                    <div className="sm:col-span-2">
                                                        ...
                                                        <DatePicker
                                                            ...
                                                            format="YYYY/MM/DD"
                                                            value={announcementsData.end_timestamp ?
                                                                moment
                                                                    .unix(
