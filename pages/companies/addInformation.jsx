...
export default function AddUser() {
  ...
  function addShareHolder() {
    setShareHolder([
      ...shareHolder,
      { name: "", percent: "", value: "", description: "" },
    ]);
  }
  ...
  const onSubmit = async (event) => {
    ...
    axios
      .post("/api/v1/company/add", {
        ...
        board: board,
        share_holder_np_date: shareHolderNPDate
          ? String(shareHolderNPDate.unix)
          : "",
        share_holder_np_no: shareHolderNPNo,
        board_member_np_date: boardMemberNPDate
          ? String(boardMemberNPDate.unix)
          : "",
                      ...
                      <div className="mt-6 mb-5 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        ...
                        <div className="sm:col-span-2">
                          <InputBox
                            ...
                            value={nationalID}
                            onChange={(event) =>
                              setNationalID(event.target.value.slice(0, 11))
                            }
                        ...
                        <div className="sm:col-span-2">
                          <InputBox
                            ...
                            onChange={(event) =>
                              setRegistrationID(event.target.value.slice(0, 10))
                            }
                        ...
                        <div
                          className={`${
                            superAdmin ? "sm:col-span-2" : "sm:col-span-4"
                          }`}
                        >
                          <InputBox
                            title="آدرس ثبتی *"
                        ...
                        {superAdmin ? (
                          <div className="sm:col-span-2">
                            <InputBox
                              ...
                              value={indicator}
                              onChange={(event) =>
                                setIndicator(event.target.value.slice(0, 3))
                              }
                        ...
                        <div className="sm:col-span-2">
                          <InputBox
                            ...
                            value={auditInst}
                            onChange={(event) =>
                              setAuditInst(event.target.value)
                            }
                        ...
                        <div className="sm:col-span-2">
                          ...
                          >
                            <Select
                              ...
                              onChange={(event) =>
                                setDaneshBonyanStatus(event.target.value)
                              }
                            >
                              ...
                              return (
                                <tr key={index}>
                                  ...
                                  <td>
                                    <input
                                      type="text"
                                      value={item.sharhEghdam}
                                      onChange={(e) =>
                                        changeProduct(index, e.target.value)
                                      }
                                  ...
                                  <td>
                                    <button
                                      type="button"
                                      onClick={(_) => removeMosavabat(index)}
                          ...
                          <div className="flex">
                            <div className="ml-2">
                              <InputBox
                                ...
                                onChange={(event) =>
                                  setShareHolderNPaperNo(event.target.value)
                                }
                            ...
                            <div>
                              ...
                              <DatePicker
                                id="321"
                                format="YYYY/MM/DD"
                                value={shareHolderNPDate}
                                onChange={(date) => {
                                  setShareHolderNPDate(date);
                                }}
                                calendar={persian}
                                locale={persian_fa}
                                placeholder="انتخاب کنید.."
                                ...
                                <tr key={index}>
                                  ...
                                  <td>
                                    <input
                                      ...
                                      value={item.value}
                                      onChange={(e) =>
                                        changeSHareHolderAmount(
                                          index,
                                          e.target.value
                                        )
                                      }
                                      className="text-sm text-center w-full border-0 p-2"
                                      placeholder="ارزش سهام"
                                    />
                                  </td>
                                  <td>
                                    <input
                                  ...
                                  <td>
                                    <button
                                      type="button"
                                      onClick={(_) => removeShareHolder(index)}
                                      className="hover:bg-gray-50 transition duration-150 text-sm flex items-center"
                                    >
                                      <svg
                                        xmlns="http://www.w3.org/2000/svg"
                          ...
                          <div className="flex">
                            <div className="ml-2">
                              <InputBox
                                ...
                                onChange={(event) =>
                                  setBoardMemberNPNo(event.target.value)
                                }
                            ...
                            <div>
                              ...
                              <DatePicker
                                id="321"
                                format="YYYY/MM/DD"
                                value={boardMemberNPDate}
                                onChange={(date) => {
                                  setBoardMemberNPDate(date);
                                }}
                                calendar={persian}
                                locale={persian_fa}
                                placeholder="انتخاب کنید.."
                                ...
                                <tr key={index}>
                                  ...
                                  <td>
                                    <input
                                      ...
                                      value={item.sharhEghdam}
                                      onChange={(e) =>
                                        changeBoardName(index, e.target.value)
                                      }
                                      className="text-sm w-full border-0 p-2"
                                  ...
                                  <td>
                                    <input
                                      ...
                                      value={item.eghdamKonande}
                                      onChange={(e) =>
                                        changeBoardSign(index, e.target.value)
                                      }
                                      className="text-sm text-center w-full border-0 p-2"
                                      placeholder="امضای مجاز"
                                    />
                                  </td>
                                  <td>
                                    <input
                            ...
                            <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                              <div className="space-y-1 text-center">
                                ...
                                <div className="flex text-sm text-gray-600">
                                  ...
                                  <p className="pr-1">
                                    یا تصویر را اینجا بکشید
                                  </p>
                                </div>
                                <p className="text-xs text-gray-500">
                                  PNG, JPG, GIF کمتر از ۱۰ مگابایت
                                </p>
                              </div>
                            </div>
                          ) : (
