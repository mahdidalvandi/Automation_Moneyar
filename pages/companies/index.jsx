          ...
          <main>
            <div className="py-6">
                ...
                <div className="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
                  <div className="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-nowrap">
                    ...
                    <div className="ml-4 mt-2 flex-shrink-0">
                      ...
                      {CheckIfAccess("add_company") ?
                        <Link href="/companies/addInformation">
                          <button
                            type="button"
              ...
              <div className="w-full px-4 sm:px-6 md:px-8">
                {currentUserRole ?
                  <CompaniesTable loadingData={false} data={searchHasValue ? searchData : data} roleData={currentUserRole} /> : null}
              </div>
            </div>
          </main> : <Forbidden />}
      </div>
