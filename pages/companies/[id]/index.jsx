                                        ...
                                        <div className="mt-2 mb-2 grid grid-cols-1 gap-y-5 gap-x-2 sm:grid-cols-6">
                                            ...
                                            <div className="sm:col-span-2">
                                                ...
                                                <FormControl fullWidth variant="standard" sx={{ m: 1 }}>
                                                    <Select
                                                        ...
                                                        disabled
                                                        value={companyData && companyData.company_type >= 0 ? companyData.company_type : -1}
                                                    >
                                            ...
                                            <div className="sm:col-span-2 ml-5">
                                                ...
                                                <FormControl fullWidth variant="standard" sx={{ m: 1 }}>
                                                    <Select
                                                        ...
                                                        id="demo-simple-select"
                                                        disabled
                                                        value={companyData && companyData.activity_type >= 0 ? companyData.activity_type : -1}
                                                    >
                                                        <MenuItem value={undefined}>ثبت نشده است</MenuItem>
                                                        <MenuItem value={-1}>ثبت نشده است</MenuItem>
                                            ...
                                            <div className="sm:col-span-2">
                                                ...
                                                <FormControl fullWidth variant="standard" sx={{ m: 1 }}>
                                                    <Select
                                                        ...
                                                        id="demo-simple-select"
                                                        disabled
                                                        value={companyData && companyData.daneshBonyan_status >= 0 ? companyData.daneshBonyan_status : -1}
                                                    >
                                                        <MenuItem value={undefined}>ثبت نشده است</MenuItem>
                                                        <MenuItem value={-1}>ثبت نشده است</MenuItem>
                                            ...
                                            <div className="col-span-6 border-t border-gray-300 py-5">
                                                ...
                                                <div >
                                                    <table className="font-light table-auto w-full text-sm font-light my-3 shadow rounded-md overflow-hidden">
                                                        ...
                                                        <tbody>
                                                            {
                                                                companyData.products && companyData.products.map((item, index) => {
                                                                    return (
                                                                        <tr key={index}>
                                                                            ...
                                                                            <td>
                                                                                <p className="text-sm w-full border-0 p-2" >{item.product}</p>

                                                                            </td>
                                                                            <td>
                                                                                <input type="text" disabled value={item.description} className="text-sm text-center w-full border-0 p-2" placeholder="ثبت نشده" />
                                                                            </td>
                                            ...
                                            <div className="col-span-6  border-t border-gray-300 py-5">
                                                <div className="flex justify-between ">
                                                    ...
                                                    <div className="flex ">
                                                        <div className="ml-2 mt-6 ">
                                                            {companyData.share_holder_attachment && Object.keys(companyData.share_holder_attachment).length != 0
                                                                ? companyData.share_holder_attachment.map((file, index) => (
                                                                    <span
                                                                        key={index}
                                                ...
                                                <div >
                                                    <table className="font-light table-auto w-full text-sm font-light my-3 shadow rounded-md overflow-hidden">
                                                        ...
                                                        <tbody>
                                                            {
                                                                companyData.share_holder && companyData.share_holder.map((item, index) => {
                                                                    return (
                                                                        <tr key={index}>
                                                                            <td className="text-center">
                                                                                {index + 1}
                                                                            ...
                                                                            <td>
                                                                                <p className="text-sm w-full border-0 p-2" >{item.name}</p>
                                                                            </td>
                                                                            <td>
                                                                                <input type="text" disabled value={item.percent} className="text-sm text-center w-full border-0 p-2" placeholder="ثبت نشده" />
                                                                            </td>
                                                                            <td>
                                                                                <input type="text" disabled value={item.value} className="text-sm text-center w-full border-0 p-2" placeholder="ثبت نشده" />
                                                                            </td>
                                                                            <td>
                                                                                <input type="text" disabled value={item.description} className="text-sm text-center w-full border-0 p-2" placeholder="ثبت نشده" />
                                                                            </td>
                                            ...
                                            <div className="col-span-6  border-t border-gray-300 py-5">
                                                <div className="flex justify-between ">
                                                    ...
                                                    <div className="flex ">
                                                        <div className="ml-2 mt-6 ">
                                                            {companyData.board_attachment && Object.keys(companyData.board_attachment).length != 0
                                                                ? companyData.board_attachment.map((file, index) => (
                                                                    <span
                                                                        key={index}
                                                                        className="relative z-0 inline-flex shadow-sm rounded-md h-full mr-2"
                                                                    >
                                                ...
                                                <div >
                                                    <table className="font-light table-auto w-full text-sm font-light my-3 shadow rounded-md overflow-hidden">
                                                        ...
                                                        <tbody>
                                                            {
                                                                companyData.board && companyData.board.map((item, index) => {
                                                                    return (
                                                                        <tr key={index}>
                                                                            <td className="text-center">
                                                                                {index + 1}
                                                                            ...
                                                                            <td>
                                                                                <input type="text" disabled value={item.position} className="text-sm text-center w-full border-0 p-2" placeholder="ثبت نشده" />
                                                                            </td>
                                                                            <td>
                                                                                <input type="text" disabled value={item.sign} className="text-sm text-center w-full border-0 p-2" placeholder="ثبت نشده" />
                                                                            </td>
                                                                            <td>
                                                                                <input type="text" disabled value={item.description} className="text-sm text-center w-full border-0 p-2" placeholder="ثبت نشده" />
                                                                            </td>
                                            ...
                                            <div className="col-span-6  border-t border-gray-300 py-5">
                                                ...
                                                <div >
                                                    <table className="font-light table-auto w-full text-sm font-light my-3 shadow rounded-md overflow-hidden">
                                                        ...
                                                        <tbody>
                                                            {
                                                                companyData.banks && companyData.banks.map((item, index) => {
                                                                    return (
                                                                        <tr key={index}>
                                                                            <td className="text-center">
                                                                                {index + 1}
                                                                            ...
                                                                            <td>
                                                                                <p className="text-sm w-full border-0 p-2" >{item.title}</p>
                                                                            </td>
                                                                            <td>
                                                                                <input type="text" disabled value={item.deposit} className="text-sm text-center w-full border-0 p-2" placeholder="ثبت نشده" />
                                                                            </td>
                                                                            <td>
                                                                                <input type="text" disabled value={item.iban} className="text-sm text-center w-full border-0 p-2" placeholder="ثبت نشده" />
                                                                            </td>
                                                                        </tr>
                                                                    )
                                                                })
