...
import IncomeHeadingsTable from "../../../components/table/incomeHeadingTable";
...
function InitialData() {
    ...
    const onSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios({
                method: "post",
                url: "/api/v1/company/income_headings/new",
                data: postFormData,
            });
    ...
    //         await axios
    //             .get("api/v1/company/incomeHeadings/list")
    //             .then((response) => {
                    ...
                    <main>
                        <div className="py-6">
                                ...
                                <div className="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
                                    <div className="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-nowrap">
                                        ...
                                        <div className="ml-4 mt-2 flex-shrink-0">
                                            {CheckIfAccess("add_income_headings") ?
                                                <button
                                                    type="button"
                            ...
                            <div className="w-full px-4 sm:px-6 md:px-8">
                                {currentUserRole ?
                                    <IncomeHeadingsTable roleData={currentUserRole} /> : null}
                            </div>
                        </div>
