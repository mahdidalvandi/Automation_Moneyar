...
export default function AddUser() {
  ...
  const { getInterview, interviewData, isInterviewLoading, error } =
    useInterview();
  ...
  useEffect(() => {
    if (router.isReady) {
      ...
      if (interviewData) {
        interviewData.fatherName
          ? setFatherName(interviewData.fatherName)
          : null;
  ...
  useEffect(() => {
    if (interviewData) {
      ...
      interviewData.registerPlace
        ? setRegisterPlate(interviewData.registerPlace)
        : null;
      interviewData.nationalCode
        ? setNationalCode(interviewData.nationalCode)
        : null;
      interviewData.gender != null && interviewData.gender != "-1"
        ? setGender(interviewData.gender)
        : null;
      interviewData.religion ? setReligion(interviewData.religion) : null;
      interviewData.religionBranch
        ? setReligionBranch(interviewData.religionBranch)
        : null;
      interviewData.citizenShip
        ? setCitizenShip(interviewData.citizenShip)
        : null;
      interviewData.vehicleStatus != null && interviewData.vehicleStatus != "-1"
        ? setVehicleStatus(interviewData.vehicleStatus)
        : null;
      interviewData.militaryStatus != null &&
      interviewData.militaryStatus != "-1"
        ? setMilitaryStatus(interviewData.militaryStatus)
        : null;
      interviewData.militaryStatusDesc
        ? setMilitaryStatusDesc(interviewData.militaryStatusDesc)
        : null;
      interviewData.marriageStatus != null &&
      interviewData.marriageStatus != "-1"
        ? setMarriageStatus(interviewData.marriageStatus)
        : null;
      interviewData.doctorStatus != null && interviewData.doctorStatus != "-1"
        ? setDoctorStatus(interviewData.doctorStatus)
        : null;
      interviewData.doctorStatusPlace
        ? setDoctorStatusPlace(interviewData.doctorStatusPlace)
        : null;
      ...
      interviewData.criminalStatus != null &&
      interviewData.criminalStatus != "-1"
        ? setCriminalStatus(interviewData.criminalStatus)
        : null;
      interviewData.criminalDescription
        ? setCriminalDescription(interviewData.criminalDescription)
        : null;
      interviewData.surgeryStatus != null && interviewData.surgeryStatus != "-1"
        ? setSurgeryStatus(interviewData.surgeryStatus)
        : null;
      interviewData.surgeryDescription
        ? setSurgeryDescription(interviewData.surgeryDescription)
        : null;
      interviewData.freeTimeDescription
        ? setFreeTimeDescription(interviewData.freeTimeDescription)
        : null;
      interviewData.knowing ? setKnowing(interviewData.knowing) : null;
      interviewData.friendStatus != null && interviewData.friendStatus != "-1"
        ? setFriendStatus(interviewData.friendStatus)
        : null;
      interviewData.friendDescription
        ? setFriendDescription(interviewData.friendDescription)
        : null;
      interviewData.insuranceType != null && interviewData.insuranceType != "-1"
        ? setInsuranceType(interviewData.insuranceType)
        : null;
      interviewData.coOperateStatus != null &&
      interviewData.coOperateStatus != "-1"
        ? setCoOperateStatus(interviewData.coOperateStatus)
        : null;
      interviewData.insuranceMonth
        ? setInsuranceMonth(interviewData.insuranceMonth)
        : null;
      interviewData.insuranceNumber
        ? setInsuranceNumber(interviewData.insuranceNumber)
        : null;
      interviewData.insuranceYear
        ? setInsuranceYear(interviewData.insuranceYear)
        : null;
      ...
      interviewData.birthDate && interviewData.birthDate != ""
        ? setSvaedBirthDate(interviewData.birthDate)
        : null;
      interviewData.birthDate && interviewData.birthDate != ""
        ? setPrevBirthDate(
            moment.unix(interviewData.birthDate).format("YYYY/MM/DD")
          )
        : null;
    }
  }, [interviewData]);
  ...
  function addLanguage() {
    setLanguage([
      ...language,
      { name: "", conversation: -1, translate: -1, reading: -1, writing: -1 },
    ]);
  }
  ...
  function addTraining() {
    setTraining([
      ...training,
      { name: "", duration: "", organizer: "", year: "", description: "" },
    ]);
  }
  ...
  const removeNonNumericWithDot = (num) =>
      ...
      {interviewData && !error ? (
                  ...
                  >
                      ...
                      <div className="lg:col-span-5 xs:col-span-1">
                        <div className="grid mt-5 grid-cols-6 w-full gap-y-1 gap-x-1 sm:grid-cols-6">
                          <div className="col-span-6 text-white">
                            <p className="mb-3 ">
                              نام و نام خانوادگی مصاحبه کننده:{" "}
                              {interviewData.interviewer_name}
                            </p>
                            <p className="mb-3 ">
                              موقیعت شغلی:{" "}
                              {interviewData.applicant_job_position}
                            </p>
                            <p className="mb-3">
                              زمان مصاحبه:{" "}
                              {moment
                                .unix(interviewData.timestamp)
                                .format("HH:mm   YYYY/MM/DD")}
                            </p>
                            <p>
                              آدرس محل مصاحبه: {interviewData.interview_place}
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                      <div className="sm:col-span-2">
                        <InputBox
                          ...
                          value={nameAndFamily}
                          onChange={(event) =>
                            setNameAndFamily(event.target.value)
                          }
                      ...
                      <div className="sm:col-span-2">
                        ...
                        <DatePicker
                          id="321"
                          format="YYYY/MM/DD"
                          value={birthDate ? birthDate : PrevBirthDate}
                          onChange={(date) => {
                            setBirthDate(date);
                          }}
                          calendar={persian}
                      ...
                      <div className="sm:col-span-2">
                        <InputBox
                          ...
                          value={registerPlace}
                          onChange={(event) =>
                            setRegisterPlate(event.target.value)
                          }
                      ...
                      <div className="sm:col-span-2">
                        ...
                        <fieldset className="mt-4">
                          <div className="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-1">
                            {genderTypeMethods.map((genderTypeMethods) => (
                              <div
                                key={`genderStatusTypeMethods${genderTypeMethods.id}`}
                                className="flex items-center"
                              >
                                <label
                                  htmlFor={`genderStatusTypeMethods${genderTypeMethods.id}`}
                                  className="ml-3 block text-sm font-medium text-gray-700"
                                >
                                  <input
                                    id={genderTypeMethods.id}
                                    name="GenderStatusMethod"
                                    type="radio"
                                    checked={
                                      genderTypeMethods.id === gender.toString()
                                    }
                      ...
                      <div className="sm:col-span-2">
                        <InputBox
                          ...
                          onChange={(event) =>
                            setReligionBranch(event.target.value)
                          }
                          error={errors["religionBranch"]}
                          type="text"
                          isrequired="true"
                        />
                      </div>
                      ...
                      <div className="sm:col-span-6 grid-cols-6 grid">
                              ...
                              <div className="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-1">
                                {marriageStatusTypeMethods.map(
                                  (marriageStatusTypeMethods) => (
                                    <div
                                      key={`marriageStatusTypeMethods${marriageStatusTypeMethods.id}`}
                                      className="flex items-center"
                                    >
                                      <label
                                        htmlFor={`marriageStatusTypeMethods${marriageStatusTypeMethods.id}`}
                                        className="ml-3 block text-sm font-medium text-gray-700"
                                      >
                                        <input
                              ...
                              <div className="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-1">
                                {vehicleStatusTypeMethods.map(
                                  (vehicleStatusTypeMethods) => (
                                    <div
                                      key={`vehicleStatusTypeMethods${vehicleStatusTypeMethods.id}`}
                                      className="flex items-center"
                                    >
                                      <label
                                        htmlFor={`vehicleStatusTypeMethods${vehicleStatusTypeMethods.id}`}
                                        className="ml-3 block text-sm font-medium text-gray-700"
                                      >
                                        <input
                                          id={vehicleStatusTypeMethods.id}
                            ...
                            <fieldset className="mt-4">
                              <div className="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-1">
                                {militaryTypeMethods.map(
                                  (militaryTypeMethods) => (
                                    <div
                                      key={`militaryTypeMethods${militaryTypeMethods.id}`}
                                      className="flex items-center"
                                    >
                                      <label
                                        htmlFor={`militaryTypeMethods${militaryTypeMethods.id}`}
                                        className="ml-3 block text-sm font-medium text-gray-700"
                                      >
                                        <input
                                          id={militaryTypeMethods.id}
                                          name="militaryMethod"
                                          type="radio"
                                          checked={
                        ...
                        <div className="col-span-2 mt-4">
                          {militaryStatus == "2" ? (
                            <input
                              type="text"
                              value={militaryStatusDesc}
                              onChange={(e) =>
                                setMilitaryStatusDesc(e.target.value)
                              }
                          ...
                          <div className="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                            {doctorStatusTypeMethods.map(
                              (doctorStatusTypeMethods) => (
                                <div
                                  key={`doctorStatusTypeMethods${doctorStatusTypeMethods.id}`}
                                  className="flex items-center"
                                >
                                  <label
                                    htmlFor={`doctorStatusTypeMethods${doctorStatusTypeMethods.id}`}
                                    className="ml-3 block text-sm font-medium text-gray-700"
                                  >
                                    <input
                                      id={doctorStatusTypeMethods.id}
                      ...
                      <div className="sm:col-span-2">
                        {doctorStatus == 0 ? (
                          <input
                            ...
                            onChange={(e) =>
                              setDoctorStatusPlace(e.target.value)
                            }
                            className="text-sm col-span-2 text-right w-full border border-gray-300 rounded-md shadow-sm p-2"
                            placeholder="محل طرح"
                          />
                    ...
                    <div className="sm:col-span-6  border-t border-gray-300 py-5">
                      ...
                      <button
                        type="button"
                        onClick={(_) => addResume()}
                        className="hover:bg-gray-50 transition duration-150 shadow p-2 px-4 rounded-md text-sm flex items-center"
                      >
                        <svg
                              ...
                              <tr key={index}>
                                ...
                                <td>
                                  <input
                                    ...
                                    value={item.place}
                                    onChange={(e) =>
                                      changePlace(index, e.target.value)
                                    }
                                ...
                                <td>
                                  <input
                                    ...
                                    value={item.position}
                                    onChange={(e) =>
                                      changePosition(index, e.target.value)
                                    }
                                ...
                                <td>
                                  <input
                                    ...
                                    value={item.endDate}
                                    onChange={(e) =>
                                      changeEndDate(index, e.target.value)
                                    }
                                    className="text-sm text-center w-full border-0 p-2"
                                ...
                                <td>
                                  <input
                                    ...
                                    onChange={(e) =>
                                      changeleavingWorkReason(
                                        index,
                                        e.target.value
                                      )
                                    }
                                    className="text-sm text-center w-full border-0 p-2"
                                    placeholder="علت ترک کار"
                                  />
                                </td>
                                <td>
                                  <input
                                    ...
                                    value={item.desc}
                                    onChange={(e) =>
                                      changeDesc(index, e.target.value)
                                    }
                                    className="text-sm text-center w-full border-0 p-2"
                                    placeholder="توضیحات"
                                  />
                                ...
                                <td>
                                  <button
                                    type="button"
                                    onClick={(_) => removeResume(index)}
                                    className="hover:bg-gray-50 transition duration-150 text-sm flex items-center"
                                  >
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="sm:col-span-6 border-t border-gray-300 py-5">
                      ...
                      <button
                        type="button"
                        onClick={(_) => addEducation()}
                        className="hover:bg-gray-50 mb-2 mt-2 transition duration-150 shadow p-2 px-4 rounded-md text-sm flex items-center"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className={"h-5 ml-1"}
                              ...
                              <tr key={index}>
                                ...
                                <td>
                                  <input
                                    ...
                                    value={item.grade}
                                    onChange={(e) =>
                                      changeGrade(index, e.target.value)
                                    }
                                    className="text-sm w-full text-center border-0 p-2"
                                    placeholder="مقطع"
                                  />
                                ...
                                <td>
                                  <input
                                    ...
                                    onChange={(e) =>
                                      changeOrientation(index, e.target.value)
                                    }
                                    className="text-sm text-center w-full border-0 p-2"
                                ...
                                <td>
                                  <input
                                    ...
                                    onChange={(e) =>
                                      changeInstitute(index, e.target.value)
                                    }
                                    className="text-sm text-center w-full border-0 p-2"
                                ...
                                <td>
                                  <input
                                    ...
                                    value={item.thesis}
                                    onChange={(e) =>
                                      changeThesis(index, e.target.value)
                                    }
                                    className="text-sm text-center w-full border-0 p-2"
                                    placeholder="موضوع پایان نامه"
                                  />
                                </td>
                                <td>
                                  <input
                                    ...
                                    value={item.startDate}
                                    onChange={(e) =>
                                      changeEduStartDate(index, e.target.value)
                                    }
                                    className="text-sm text-center w-full border-0 p-2"
                                ...
                                <td>
                                  <input
                                    ...
                                    value={item.endDate}
                                    onChange={(e) =>
                                      changeEduEndDate(index, e.target.value)
                                    }
                                    className="text-sm text-center w-full border-0 p-2"
                                ...
                                <td>
                                  <input
                                    ...
                                    value={item.gpa}
                                    onChange={(e) =>
                                      changeGpa(index, e.target.value)
                                    }
                                    className="text-sm text-center w-full border-0 p-2"
                                    placeholder="معدل"
                                  />
                                ...
                                <td>
                                  <button
                                    type="button"
                                    onClick={(_) => removeEducation(index)}
                                    className="hover:bg-gray-50 transition duration-150 text-sm flex items-center"
                                  >
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="sm:col-span-6 border-t border-gray-300 py-5">
                      ...
                      <button
                        type="button"
                        onClick={(_) => addLanguage()}
                        className="hover:bg-gray-50 mt-2 mb-2 transition duration-150 shadow p-2 px-4 rounded-md text-sm flex items-center"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className={"h-5 ml-1"}
                              ...
                              <tr key={index}>
                                ...
                                <td>
                                  <input
                                    ...
                                    value={item.name}
                                    onChange={(e) =>
                                      changeLangName(index, e.target.value)
                                    }
                                    className="text-sm w-full text-center border-0 p-2"
                                  ...
                                  <fieldset className="flex min-h-full items-center justify-center">
                                    <div className=" sm:flex sm:items-center">
                                      {languageTypeMethods.map(
                                        (languageTypeMethods) => (
                                          <div
                                            key={`languageMethodConv${languageTypeMethods.id}${index}`}
                                            className="flex items-center"
                                          >
                                            <label
                                              htmlFor={`languageMethodConv${languageTypeMethods.id}${index}`}
                                              className="ml-3 block text-sm font-medium text-gray-700"
                                            >
                                              <input
                                                id={languageTypeMethods.id}
                                  ...
                                  <fieldset className="flex min-h-full items-center justify-center">
                                    <div className=" sm:flex sm:items-center">
                                      {languageTypeMethods.map(
                                        (languageTypeMethods) => (
                                          <div
                                            key={`languageMethodTrans${languageTypeMethods.id}${index}`}
                                            className="flex items-center"
                                          >
                                            <label
                                              htmlFor={`languageMethodTrans${languageTypeMethods.id}${index}`}
                                              className="ml-3 block text-sm font-medium text-gray-700"
                                            >
                                              <input
                                                id={languageTypeMethods.id}
                                  ...
                                  <fieldset className="flex min-h-full items-center justify-center">
                                    <div className=" sm:flex sm:items-center">
                                      {languageTypeMethods.map(
                                        (languageTypeMethods) => (
                                          <div
                                            key={`languageMethodReading${languageTypeMethods.id}${index}`}
                                            className="flex items-center"
                                          >
                                            <label
                                              htmlFor={`languageMethodReading${languageTypeMethods.id}${index}`}
                                              className="ml-3 block text-sm font-medium text-gray-700"
                                            >
                                              <input
                                                id={languageTypeMethods.id}
                                  ...
                                  <fieldset className="flex min-h-full items-center justify-center">
                                    <div className=" sm:flex sm:items-center">
                                      {languageTypeMethods.map(
                                        (languageTypeMethods) => (
                                          <div
                                            key={`languageMethodWriting${languageTypeMethods.id}${index}`}
                                            className="flex items-center"
                                          >
                                            <label
                                              htmlFor={`languageMethodWriting${languageTypeMethods.id}${index}`}
                                              className="ml-3 block text-sm font-medium text-gray-700"
                                            >
                                              <input
                                                id={languageTypeMethods.id}
                                ...
                                <td>
                                  <button
                                    type="button"
                                    onClick={(_) => removeLanguage(index)}
                                    className="hover:bg-gray-50 transition duration-150 text-sm flex items-center"
                                  >
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                              ...
                              <tr key={index}>
                                ...
                                <td>
                                  <input
                                    ...
                                    value={item.type}
                                    onChange={(e) =>
                                      changeSkillType(index, e.target.value)
                                    }
                                    className="text-sm w-full text-center border-0 p-2"
                                    placeholder="نوع مهارت"
                                  />
                                </td>
                                <td>
                                  <input
                                  ...
                                  <fieldset className="flex min-h-full items-center justify-center">
                                    <div className=" sm:flex sm:items-center">
                                      {languageTypeMethods.map(
                                        (languageTypeMethods) => (
                                          <div
                                            key={`SkillMethod${languageTypeMethods.id}${index}`}
                                            className="flex items-center"
                                          >
                                            <label
                                              htmlFor={`SkillMethod${languageTypeMethods.id}${index}`}
                                              className="ml-3 block text-sm font-medium text-gray-700"
                                            >
                                              <input
                                                id={languageTypeMethods.id}
                              ...
                              <tr key={index}>
                                ...
                                <td>
                                  <input
                                    ...
                                    value={item.name}
                                    onChange={(e) =>
                                      changeTrainingName(index, e.target.value)
                                    }
                                    className="text-sm w-full text-center border-0 p-2"
                                ...
                                <td>
                                  <input
                                    ...
                                    value={item.year}
                                    onChange={(e) =>
                                      changeTrainingYear(index, e.target.value)
                                    }
                                    className="text-sm w-full text-center border-0 p-2"
                                ...
                                <td>
                                  <button
                                    type="button"
                                    onClick={(_) => removeTraining(index)}
                                    className="hover:bg-gray-50 transition duration-150 text-sm flex items-center"
                                  >
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                          ...
                          <fieldset className="mr-4">
                            <div className="space-y-4 sm:flex  sm:space-y-0 sm:space-x-1">
                              {yesAndNoTypeMethods.map(
                                (yesAndNoTypeMethods) => (
                                  <div
                                    key={`criminalYesAndNoTypeMethods${yesAndNoTypeMethods.id}`}
                                    className="flex items-center"
                                  >
                                    <label
                                      htmlFor={`criminalYesAndNoTypeMethods${yesAndNoTypeMethods.id}`}
                                      className="ml-3 block text-sm font-medium text-gray-700"
                                    >
                                      <input
                                        id={yesAndNoTypeMethods.id}
                                        name="criminalTypeMethod"
                                        type="radio"
                                        checked={
                                          yesAndNoTypeMethods.id ==
                                          criminalStatus.toString()
                                        }
                                        className="focus:ring-amber-500 h-4 w-4 text-amber-600 border-gray-300 ml-2"
                                        onChange={(e) => {
                                          setCriminalStatus(e.target.id);
                                        }}
                                      />
                        ...
                        <div className="col-span-4 pt-1">
                          {criminalStatus == "0" ? (
                            <input
                              ...
                              onChange={(e) =>
                                setCriminalDescription(e.target.value)
                              }
                              className="text-sm col-span-2 text-right w-full border border-gray-300 rounded-md shadow-sm p-2"
                          ...
                          <fieldset className="mr-4">
                            <div className="space-y-4 sm:flex  sm:space-y-0 sm:space-x-1">
                              {yesAndNoTypeMethods.map(
                                (yesAndNoTypeMethods) => (
                                  <div
                                    key={`surjeryYesAndNoTypeMethods${yesAndNoTypeMethods.id}`}
                                    className="flex items-center"
                                  >
                                    <label
                                      htmlFor={`surjeryYesAndNoTypeMethods${yesAndNoTypeMethods.id}`}
                                      className="ml-3 block text-sm font-medium text-gray-700"
                                    >
                                      <input
                                        id={yesAndNoTypeMethods.id}
                        ...
                        <div className="col-span-4 pt-1">
                          {surgeryStatus == "0" ? (
                            <input
                              ...
                              onChange={(e) =>
                                setSurgeryDescription(e.target.value)
                              }
                              className="text-sm col-span-2 text-right w-full border border-gray-300 rounded-md shadow-sm p-2"
                              placeholder="در صورت مثبت بودن توضیح دهید"
                            />
                      ...
                      <div className="grid lg:grid-cols-6 w-full gap-y-1 gap-x-4 xs:grid-cols-1">
                        ...
                        <div className="col-span-4 pt-1">
                          <input
                            ...
                            onChange={(e) =>
                              setFreeTimeDescription(e.target.value)
                            }
                          ...
                          <fieldset className="mr-4">
                            <div className="space-y-4 sm:flex  sm:space-y-0 sm:space-x-1">
                              {yesAndNoTypeMethods.map(
                                (yesAndNoTypeMethods) => (
                                  <div
                                    key={`friendYesAndNoTypeMethods${yesAndNoTypeMethods.id}`}
                                    className="flex items-center"
                                  >
                                    <label
                                      htmlFor={`friendYesAndNoTypeMethods${yesAndNoTypeMethods.id}`}
                                      className="ml-3 block text-sm font-medium text-gray-700"
                                    >
                                      <input
                                        id={yesAndNoTypeMethods.id}
                      ...
                      <div className="grid lg:grid-cols-6 w-full gap-y-1 gap-x-4 xs:grid-cols-2">
                            ...
                            <div className="space-y-4 sm:flex  sm:space-y-0 sm:space-x-1">
                              {coOperateTypeMethods.map(
                                (coOperateTypeMethods) => (
                                  <div
                                    key={`coOperateTypeMethods${coOperateTypeMethods.id}`}
                                    className="flex items-center"
                                  >
                                    <label
                                      htmlFor={`coOperateTypeMethods${coOperateTypeMethods.id}`}
                                      className="ml-3 block text-sm font-medium text-gray-700"
                                    >
                                      <input
                                        id={coOperateTypeMethods.id}
                                        name="coOperateTypeMethod"
                                        type="radio"
                                        checked={
                                          coOperateTypeMethods.id ==
                                          coOperateStatus.toString()
                                        }
                                        className="focus:ring-amber-500 h-4 w-4 text-amber-600 border-gray-300 ml-2"
                                        onChange={(e) => {
                                          setCoOperateStatus(e.target.id);
                                        }}
                                      />
                        ...
                        <div className="col-span-4 pt-1">
                          <input
                            ...
                            className="text-sm col-span-2 text-right w-full border border-gray-300 rounded-md shadow-sm p-2"
                            placeholder="میزان حقوق درخواستی را بیان کنید"
                          />
                        </div>
                      </div>
                    </div>
                          ...
                          <div className="grid lg:grid-cols-6 w-full gap-y-2 gap-x-4 xs:grid-cols-2">
                            <div className="col-span-2">
                              <p
                                ...
                                className="block text-sm  font-medium text-gray-700"
                              >
                                چنانچه قبلا تحت پوشش بیمه بوده اید، نوع آن را
                                مشخص کنید
                              </p>
                            </div>
                            <div className="col-span-2">
                                ...
                                <div className="space-y-1 sm:flex  xs:space-y-0 xs:space-x-1">
                                  {insuranceTypeMethods.map(
                                    (insuranceTypeMethods) => (
                                      <div
                                        key={`insuranceTypeMethods${insuranceTypeMethods.id}`}
                                        className="flex items-center"
                                      >
                                        <label
                                          htmlFor={`insuranceTypeMethods${insuranceTypeMethods.id}`}
                                          className="ml-3 block text-sm font-medium text-gray-700"
                                        >
                                          <input
                                            id={insuranceTypeMethods.id}
                      ...
                      <div className="grid grid-cols-6 w-full gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div className="col-span-2 flex justify-contect pt-1 ">
                          <p
                            ...
                            className="block text-sm font-medium pt-2 ml-3 text-gray-700"
                          >
                            در صورت داشتن سابقه بیمه، مدت زمان و شماره بیمه را
                            ذکر کنید:
                          </p>
                        </div>
                        <div className="col-span-4 pt-1">
                    ...
                    <div className="sm:col-span-6 mb-2">
                      ...
                      <p className="text-sm text-black-500 ">
                        اینجانب تعهد می‌نمایم که کلیه اطلاعات درخواستی را با حسن
                        نیست و در کمال صداقت پاسخ گفته و اگر در آینده هرگونه
                        خلافی از این اطلاعات مشاهده گردید به منزله استعفای
                        اینجانب از کارم تلقی شده و شرکت به هر نحو که بخواهد نسبت
                        به اعاده ضرر و زیان خود علیه اینجانب اقدام نماید. همچنین
                        پر کردن این پرسشنامه حقی در ارتباط با استخدام برای
                        اینجانب ایجاد نمی‌نماید.
                      </p>
                    </div>
                    {errors["master"] ? (
                      <span className="text-sm text-red-500">
                            ...
                            <>
                              <div className="col-span-1 ">
                                <input
                                  ...
                                  className="text-sm ml-4 w-full text-center border border-gray-300 rounded-md shadow-sm p-2"
        ...
        <div>
          <div className=" grid lg:grid-cols-7 xs:grid-cols-2 bg-red-700 p-2 mb-5 rounded-md shadow-sm">
            <div className="col-span-3"></div>
            <div className="col-span-1">
              <div className=" flex justify-center text-white">{error}</div>
            </div>
            <div className="col-span-3"></div>
          </div>
        </div>
