        ...
        {!currentUserActions ? null : CheckIfAccessToPage(
          ...
          <main>
            <div className="py-6">
              ...
              <div
                ref={listItems}
                className="grid lg:grid-cols-6 sx:grid-cols-1 gap-10 col-span-6 rounded-md p-3"
              >
                              ...
                              >
                                ...
                                <InputBox
                                  ...
                                  value={
                                    bank.totalValue
                                      ? addCommas(
                                          removeNonNumeric(bank.totalValue)
                                        )
                                ...
                                <InputBox
                                  ...
                                  disabled={checkMonth(i) || bank.hasValue}
                                  value={
                                    bank.withdrawalValue
                                      ? addCommas(
                                          removeNonNumeric(bank.withdrawalValue)
                                        )
                                      : addCommas(removeNonNumeric(0))
                                  }
                                  onChange={(event) =>
                                ...
                                {!checkMonth(i) && responseData ? (
                                  responseData[j] ? (
                                    responseData[j].success == 1 ? (
                                      <span className="text-sm text-green-700">
                                        با موفقیت ثبت شد
                                      </span>
                                    ) : responseData[j].success == 0 ? (
