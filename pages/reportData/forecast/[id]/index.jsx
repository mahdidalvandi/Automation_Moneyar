              ...
              <div className="flex justify-end">
                {!final ? (
                  <>
                    ...
                    >
                      <span>{`${
                        sendingFinalForm ? "در حال ثبت اطلاعات" : "ثبت نهایی"
                      }`}</span>
                    </button>
                    <button
                    ...
                    >
                      <span>{`${
                        sendingForm ? "در حال ذخیره اطلاعات" : "ذخیره پیش نویس"
                      }`}</span>
                    </button>
                  </>
                ) : null}
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            پس از ثبت نهایی، امکان تغییر اطلاعات وجود ندارد. آیا از ادامه عملیات
            اطمینان دارید؟
          </DialogContentText>
        </DialogContent>
        <DialogActions>
